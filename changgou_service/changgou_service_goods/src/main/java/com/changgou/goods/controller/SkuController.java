...
public class SkuController {
     ...
     * @return
     */
    @GetMapping("/findAllBySpuId/{spuId}")
    public Result<List<Sku>> findAllBySpuId(@PathVariable(name = "spuId") String spuId){
        //调用SkuService实现查询所有Sku
        List<Sku> list = skuService.findAllBySpuId(spuId);
        return new Result<List<Sku>>(true, StatusCode.OK,"查询成功",list) ;
    }
