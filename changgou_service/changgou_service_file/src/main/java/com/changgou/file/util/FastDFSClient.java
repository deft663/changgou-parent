...
public class FastDFSClient {
    ...
    static {
        try {
            String filePath = new ClassPathResource("fdfs_client.conf").getClassLoader().getResource("fdfs_client.conf").toURI().getPath();
    ...
    public static void main(String[] args) {
        ...
        hashtable.put("tracker_server","1");
        System.out.println(hashtable.get("tracker_server"));
    }
}