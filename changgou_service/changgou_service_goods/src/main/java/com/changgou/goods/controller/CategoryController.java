...
public class CategoryController {
     ...
     * @return
     */
    @GetMapping("/getCascadeCategory/{parentId}")
    public Result<Map<String,Object>> getCascadeCategory(@PathVariable Integer parentId){
        //调用CategoryService实现根据主键查询Category
        List<Map<String, Object>> list=new ArrayList<>();
        list = categoryService.getCascadeCategory(parentId, list);
        return new Result<Map<String,Object>>(true,StatusCode.OK,"查询成功",list);
    }
